pop.index.plot<-function(data,xlim1,xlim2,xinc,ylim1,ylim2,yinc)
{
 if(!is.data.frame(data)|| !("sollong"%in%names(data))|| !("pop.index"%in%names(data)) || !("r.error"%in%names(data)))
