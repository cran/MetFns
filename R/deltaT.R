...
{
   if(!is.numeric(c(year,month)) || year<1984 || month<1 || month>12)
   ...
   if(year<1986)
      deltaT<-45.45+1.067*(year-1975)-(year-1975)^2/260-(year-1975)^3/718
           ...
           deltaT<-63.86+0.3345*(year-2000)-0.060374*(year-2000)^2+0.0017275*(year-2000)^3+0.000651814*(year-2000)^4+0.00002373599*(year-2000)^5
